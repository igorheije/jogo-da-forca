var biblioteca = ["computador","brinquedo","corda","prego","carro","fone","galinha","homem","jogo","bolinha","farinha"]
...
function jogar(){
    ...
    if(jog.value==""){
        ...
        if(jogando){
            ...
            if(!acertou){
                document.getElementById("letradigitada").innerHTML+=letra.toUpperCase()
                erros++;
                if(erros<7){
...
function inicia(){
    ...
    erros=0
    acertou=false
    document.getElementById("letradigitada").innerHTML="Letras Difitadas:"
